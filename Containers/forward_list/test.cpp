...
int main(){
    ...
    my::forward_list<int> integer_list{4, 7, 9, -2};
    ...
    std::cout<<"\n";
    my::forward_list<std::vector<double>> vec_double_list={{7, 4.1, 2.01}, {-1.04, 8.75, 9.15}, {7.85, 9.64, 4, 45, -8.1456}, {1, 0.2}};
    ...
    my::forward_list<std::vector<double>> copy_vec(vec_double_list);
    ...
    my::forward_list<int> new_integer_list=std::move(integer_list);
